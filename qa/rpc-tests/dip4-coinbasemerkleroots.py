...
from test_framework.test_framework import QnodeCoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(QnodeCoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as QnodeCoinTestFramework doesn't support this atm)
