...
Arguments:
    <base_directory> - The base directory of a QnodeCoin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The QnodeCoin Core developers'
...
Arguments:
    <base_directory> - The base directory of QnodeCoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the QnodeCoin Core repository.
"""
