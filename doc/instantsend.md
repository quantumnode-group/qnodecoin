...
This mechanism has been integrated into Bitcore-Node-QnodeCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/qnodecoinpay/insight-api-qnodecoin#web-socket-api](https://github.com/qnodecoinpay/insight-api-qnodecoin#web-socket-api)
* API: [https://github.com/qnodecoinpay/insight-api-qnodecoin#instantsend-transactions](https://github.com/qnodecoinpay/insight-api-qnodecoin#instantsend-transactions)
