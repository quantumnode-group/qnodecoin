...
2. run qnodecoind with -printalert or -sendalert like this:
   /path/to/qnodecoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.qnodecoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/QnodeCoin Core:0.12.0.58/"));
