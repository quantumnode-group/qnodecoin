...
This document provides guidelines for internationalization of the QnodeCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `qnodecoin_en.ts` remains unchanged.
