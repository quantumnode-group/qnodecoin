...
// Copyright (c) 2020 The QnodeCoin Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1593077710, nBits=1e0ffff0, nNonce=1212750, vtx=1)
...
{
    const char* pszTimestamp = "Qnode blockchain finally switches to X11 algorithm";
    const CScript genesisOutputScript = CScript() << ParseHex("04b62358eb0cd36def7e42b9450f295d4dd2986d06706ce10b5e80bfdcb236a55add82983a3e674012c1d8b93215b23f425e979cc4e5b46764478dd79df98443e1") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000802cb89aa05be73de7e91ae33aec597c41f2f3832a2a95a5202400e5718"); 
        ...
        vAlertPubKey = ParseHex("04a43146f702f06d00f1bf40c20455c2d08928928cf4d06b28113002a6d108c6dc194462c763e6cec08b99aff4067995c14cc5aa38157532d19c3d01206f7ef473");
        nDefaultPort = 20612;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1593077710, 1212750, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000802cb89aa05be73de7e91ae33aec597c41f2f3832a2a95a5202400e5718"));
        assert(genesis.hashMerkleRoot == uint256S("0x3121d98b28586c64eda6c5e302bfc325787e6a9fb82ea844051a40280b14a905"));
        ...
        // QnodeCoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // QnodeCoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // QnodeCoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"98QKojtvcTraynuDSrC4bAw3tuMvqhFGbk"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000802cb89aa05be73de7e91ae33aec597c41f2f3832a2a95a5202400e5718"))
        };

        chainTxData = ChainTxData{
            1593077710, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000073e6af851c733d15318f57ca125044d3f1c820b1dc650690d6ee901ab00"); 

        pchMessageStart[0] = 0x54;
        pchMessageStart[1] = 0x06;
        pchMessageStart[2] = 0xa3;
        pchMessageStart[3] = 0x32;
        vAlertPubKey = ParseHex("044411296c08dffd1502deaafa18d9105470a517c8b41129a7d56cf7d1e859cb5329e2e5793b6a02e93e1a32128845eb54efd6e480d434705bad0e3f5d109a44cf");
        nDefaultPort = 30612;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1593077715UL, 837830UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000073e6af851c733d15318f57ca125044d3f1c820b1dc650690d6ee901ab00"));
        assert(genesis.hashMerkleRoot == uint256S("0x3121d98b28586c64eda6c5e302bfc325787e6a9fb82ea844051a40280b14a905"));
        ...
        // Testnet QnodeCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet QnodeCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet QnodeCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"Nc8hMgvhUQUvQTaDVCWoTs6NVU9Nze4KpU"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x0000073e6af851c733d15318f57ca125044d3f1c820b1dc650690d6ee901ab00"))
        };

        chainTxData = ChainTxData{
            1593077715, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1593077720, 2, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x68b2ce6e2f1a887174856e579d121a0ac684340ee5a2dc902e69b3e4b62439c0"));
        assert(genesis.hashMerkleRoot == uint256S("0x3121d98b28586c64eda6c5e302bfc325787e6a9fb82ea844051a40280b14a905"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("qnodecoinevo.org",  "devnet-seed.qnodecoinevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x68b2ce6e2f1a887174856e579d121a0ac684340ee5a2dc902e69b3e4b62439c0"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 75NR2opq9QPJ7k9m91KWW2NKkLv4Bh3gky3kN4ce2hZXDhBW42w
        vSporkAddresses = {"Nc623LCvdTiQaDDCmqCzkg5fZZTfwuCLVY"};
        nMinSporkKeys = 1;
        ...
        // Regtest QnodeCoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,53);
        // Regtest QnodeCoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,54);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,181);
        // Regtest QnodeCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest QnodeCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest QnodeCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
