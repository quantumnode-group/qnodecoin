...
//! These need to be macros, as clientversion.cpp's and qnodecoin*-res.rc's voodoo requires it
...
/**
 * qnodecoind-res.rc includes this file, but it cannot cope with real c++ code.
